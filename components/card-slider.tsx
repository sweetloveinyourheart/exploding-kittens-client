      ...
      <div className="flex flex-col items-center justify-center h-[300px] w-full relative">
        <div className="absolute top-[60px] bottom-[60px] left-1/2 transform -translate-x-1/2 flex flex-col justify-between z-0">
          {Array.from({ length: 15 }).map((_, idx) => (
            <div key={idx} className="w-[2px] h-[8px] bg-white my-[2px]" />
          ))}
        </div>
        <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-[15px] border-l-transparent border-r-[15px] border-r-transparent border-b-[20px] border-b-white z-10" />
        <motion.div
          drag="y"
          ...
          className="bg-white border-2 w-[40px] h-[40px] rounded-md flex items-center justify-center cursor-grab z-10"
        />
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-[15px] border-l-transparent border-r-[15px] border-r-transparent border-t-[20px] border-t-white z-10" />
        <div
          ref={containerRef}
